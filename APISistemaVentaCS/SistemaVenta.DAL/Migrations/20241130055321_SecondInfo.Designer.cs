...
namespace SistemaVenta.DAL.Migrations
{
    ...
    [Migration("20241130055321_SecondInfo")]
    partial class SecondInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaVenta.Model.DetalleVenta", b =>
                {
                    ...
                    b.HasOne("SistemaVenta.Model.Usuario", "IdUsuarioNavigation")
                        .WithOne("DetalleVenta")
                        .HasForeignKey("SistemaVenta.Model.DetalleVenta", "IdUsuario")
